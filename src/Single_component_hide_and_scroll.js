            ...
            <Row id='my-row-style'>
              <Col md='6'>
                ...
                <h5 style={{ fontStyle: 'italic' }}>
                  RUNNING SHOES FOR SPEED AND STABILITY.
                </h5>
                <a></a>
                <a>
                  Eliminate the noise. As you push yourself, all you can think
                  about is your movement and your breath. And that you're doing
                  it. The rest falls away. Move fast. Move slow. Just move. And
                  do it in these adidas running shoes. They're lightweight,
                  cushioned and ready to roll.
                </a>
              </Col>
              <Col md='6'>
              ...
              <Table bordered={true}>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      victor india Marketing Private ltd. 2Nd floor,Building No.
                      8, Cybersity Phase 3, Gurugram 110022
                    </td>
                  </tr>
                  <tr>
                    <td>Net Quantity</td>
            ...
            <Row>
              ...
              <Col md='4'>
                <div id='img-style'>
                  ...
                  <div id='overlay-text'>
                   <a>$</a>
                   <a style={{ textDecoration:"line-through",marginLeft:'1px' }}>2999.00</a> 
            ...
            <div id='container'>
              <div id='row'>
                ...
                <div id='card'>
                  ...
                  <p id='card-text'>
                    {' '}
                    Cream Color Sneaker <br /> Comfortable and Stylish{' '}
                  </p>
                </div>
                <div id='card'>
                  <img src={Purse} />
          ...
          <div id='right'>
            ...
            <Row>
              <Col>
                ...
                <a style={{ fontWeight: '600', color: 'red' }}> 2499.50</a>
                <br />
            ...
            <Row>
              <Col>
                <h6>Available sizes</h6> <Button outline>6</Button>{' '}
                <Button outline>7</Button> <Button outline>8</Button>{' '}
                <Button outline>9</Button> <Button outline>10</Button>{' '}
                <Button outline>11</Button>{' '}
              </Col>
            </Row>
            <br />
            <Row>
